...
export default function Dialog({ mapId }: { mapId: number }) {
  ...
  return (
    <div className="bg-black/70 text-4xl  font-font1 backdrop-blur-sm fixed top-0 left-0 right-0 bottom-0 min-w-full min-h-screen flex items-center justify-center z-40">
      <div className="bg-white/20 p-8 mx-auto  -translate-y-20 border border-yellow-300 flex flex-col rounded ">
        ...
        <button
          ...
          className="border border-yellow-300 hover:bg-yellow-200 hover:text-black p-2 mt-4 rounded "
        >
          SAVE SCORE
        </button>
      </div>
